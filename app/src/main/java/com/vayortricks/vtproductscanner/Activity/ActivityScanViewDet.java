...
import com.vayortricks.vtproductscanner.Fragment.FragmentHome;
...
public class ActivityScanViewDet extends AppCompatActivity implements View.OnClickListener {
    ...
    private LinearLayout mLinearFormat;
...
//        cameraPreview = (CameraPreview)findViewById(R.id.camera_preview);
        ...
        mLinearFormat=(LinearLayout)findViewById(R.id.linear_format);
...
//        if (!barcodeImage.equalsIgnoreCase("")) {
...
//                                }
    ...
    private void getData()
    {
        ...
        if(getIntent().getStringExtra("formatName").equalsIgnoreCase(""))
        {
            mLinearFormat.setVisibility(View.GONE);
        }else {
            mLinearFormat.setVisibility(View.VISIBLE);
        ...
        Glide.with(this)
                ...
                .into(mImgScan);
             if(ActivityScanHistory.scanFlag!="0")
             {
