 ...
 * - InactivityTimer
 * - BeepManager
 * - Initializing from an Intent (via IntentIntegrators)
 * - Setting the result and finishing the Activity when a barcode is scanned
 * - Displaying camera errors
 */
public class CaptureManagers {
    private static final String TAG = CaptureManagers.class.getSimpleName();
    ...
    public CaptureManagers(Activity activity, DecoratedBarcodeView barcodeView) {
    ...
    protected void lockOrientation() {
        ...
        if (this.orientationLock == ActivityInfo.SCREEN_ORIENTATION_FULL_SENSOR) {
...
//                    e.printStackTrace();
//                }
                File bitmapFile = new File(Environment.getExternalStorageDirectory(), System.currentTimeMillis() + ".jpg");

//                File bitmapFile = File.createTempFile( ".jpg", activity.getCacheDir());
...
//        activity.setResult(Activity.RESULT_OK, intent);
    ...
    public static void setCameraPermissionReqCode(int cameraPermissionReqCode) {
        CaptureManagers.cameraPermissionReqCode = cameraPermissionReqCode;
    }
}
