...
public class IntentIntegrators {

    public static int REQUEST_CODE = 101; // Only use bottom 16 bits
    private static final String TAG = IntentIntegrators.class.getSimpleName();
     ...
     */
    public IntentIntegrators(Activity activity) {
     ...
     */
    public IntentIntegrators setCaptureActivity(Class<?> captureActivity) {
     ...
     *                 of an {@link Activity}
     */
    public static IntentIntegrators forSupportFragment(android.support.v4.app.Fragment fragment) {
        IntentIntegrators integrator = new IntentIntegrators(fragment.getActivity());
    ...
    public static IntentIntegrators forFragment(Fragment fragment) {
        IntentIntegrators integrator = new IntentIntegrators(fragment.getActivity());
    ...
    public final IntentIntegrators addExtra(String key, Object value) {
     ...
     */
    public final IntentIntegrators setPrompt(String prompt) {
        if (prompt != null) {
     ...
     */
    public IntentIntegrators setOrientationLocked(boolean locked) {
     ...
     * @return this
     */
    public IntentIntegrators setCameraId(int cameraId) {
        if (cameraId >= 0) {
     ...
     * @return this
     */
    public IntentIntegrators setBeepEnabled(boolean enabled) {
     ...
     * @return this
     */
    public IntentIntegrators setBarcodeImageEnabled(boolean enabled) {
     ...
     * @return this
     */
    public IntentIntegrators setDesiredBarcodeFormats(Collection<String> desiredBarcodeFormats) {
     ...
     */
    public IntentIntegrators setTimeout(long timeout) {
     ...
     * else an {@link IntentResults} containing the result of the scan. If the user cancelled scanning,
     * the fields will be null.
     */
    public static IntentResults parseActivityResult(int requestCode, int resultCode, Intent intent) {
        if (requestCode == REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                return new IntentResults(contents,
                        formatName,
                        rawBytes,
                        orientation,
